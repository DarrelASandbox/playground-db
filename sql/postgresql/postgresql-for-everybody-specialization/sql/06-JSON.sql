...
\ copy jtrack (body)
FROM 'library.jstxt' WITH CSV QUOTE E '\x01' DELIMITER E '\x02';
...
SELECT
  (
    '{ "type": "Neon", "series": "24 Hours of Lemons", "number": ' || generate_series(1000, 5000) || '}'
  ) :: jsonb;
